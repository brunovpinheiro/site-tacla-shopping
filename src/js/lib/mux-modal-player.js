  ...
  `;
	...
	MuxModalPlayer.prototype._bindModalEvents = function () {
		...
		v.addEventListener("waiting", function () {
			self._spinner.classList.add("mmp-show");
		});
		...
		this._progressWrap.addEventListener("mousedown", function (e) {
			scrubbing = true;
			seek(e);
		});
	...
	MuxModalPlayer.prototype._showCenterPulse = function (icon) {
		...
		this._centerFadeTimer = setTimeout(function () {
			...
			setTimeout(function () {
				cb.classList.remove("mmp-show", "mmp-fade");
			}, 500);
		}, 600);
	};
	...
	MuxModalPlayer.prototype._bindTriggers = function () {
		...
		document.addEventListener("click", function (e) {
			...
			const src = streamUrl || (playbackId ? "https://stream.mux.com/" + playbackId + ".m3u8" : null);
